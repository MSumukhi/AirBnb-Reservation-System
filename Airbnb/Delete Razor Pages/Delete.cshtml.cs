...
///<summary>
///In Delete file, the item is deleted by id. Id is retrieved from the item and is passed to the controller to 
///delete the particular item corresponding to that id
///</summary>
namespace WebApp.Pages.Bills
{
    public class DeleteModel : PageModel
    {
        //Declaring variables for Success message
        ...
        //Method for deleting the values and updating the dataset
